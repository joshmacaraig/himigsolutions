...
const WeddingInvitation = ({ invitationData, design = 'classic' }) => {
  // Wedding-specific content - use props if available, otherwise defaults
  const {
    title = "Elena & David",
    date = "August 15, 2025",
  ...
  const designClasses = {
    classic: "wedding-theme-classic bg-white",
    modern: "wedding-theme-modern bg-gray-50",
    rustic: "wedding-theme-rustic bg-amber-50",
    minimalist: "wedding-theme-minimalist bg-neutral-50"
  };
  
  // Get the appropriate design class, defaulting to classic if not found
  const themeClass = designClasses[design] || designClasses.classic;
  ...
  const galleryImages = Array(9).fill("/img/wedding-placeholder.jpg");
