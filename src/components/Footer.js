        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-neutral-light text-sm mt-2">
              Your Story, Our Melody - Custom music and digital invitations for every special occasion.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-neutral-light hover:text-secondary transition">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-neutral-light hover:text-secondary transition">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/portfolio" className="text-neutral-light hover:text-secondary transition">
                  Portfolio
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-neutral-light hover:text-secondary transition">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services#invitations" className="text-neutral-light hover:text-secondary transition">
                  Digital Invitations
                </Link>
              </li>
              <li>
                <Link to="/services#music" className="text-neutral-light hover:text-secondary transition">
                  Custom Music
                </Link>
              </li>
              <li>
                <Link to="/services#rsvp" className="text-neutral-light hover:text-secondary transition">
                  RSVP Management
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-neutral-light">
              <li className="flex items-start">
                ...
                <span>info@himigsolutions.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <span>+63 (2) 8000-0000</span>
              </li>
            </ul>
